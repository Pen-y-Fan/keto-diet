<div class="flex items-center mb-3 odd:bg-gray-50 odd:rounded-lg p-2 shadow sm:rounded-bl-md sm:rounded-br-md">
    ...
    <div class="w-1/6 md:w-1/12"><p class="text-right">{{ number_format($food->calories) }}</p></div>
    <div class="w-1/6 md:w-1/12"><p class="text-right">{{ number_format($food->carbs) }}</p></div>
